...
public class LocatorCMS {
    ...
    public static String inputSearchBrand= "//div[@class='dropdown-menu show']//input[@aria-label='Search']";
    ...
    public static String  inputTags= "//label[.='Tags *']/following-sibling::div//input";
   ...
   public static String dropdownVideoProvider = "//label[normalize-space()='Video Provider']/following-sibling::div//button";
    ...
    public static String dropdownColors = "//div[@class='col-md-1']//span";
    public static String inputSearchColors = "//div[@class='dropdown-menu show']//input[@aria-label='Search']";

    public static String buttonGreen = "//button[@data-id='colors']";
    ...
    public static String inputQuantity= "//label[normalize-space()='Quantity *']/following-sibling::div//input";
